...
class NetworkWidget(QWidget):
    """Network preview canvas with zoom/pan toolbar and road click support."""

    road_clicked = pyqtSignal(int)   # emits road_id when user clicks near a road
    ...
    def _on_canvas_click(self, event):
        """Find the road nearest the click and emit road_clicked if close enough."""
        ...
        threshold = diag * 0.08   # 8 % of axes diagonal
        ...
        if best_rid is not None and best_dist <= threshold:
